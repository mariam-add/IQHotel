...
{
    public class DapperRepository : IDapperRepository, IRegisterSingleton
    {
        ...
        public TEntity GetEntity<TEntity>(string spName, object pars)
        {
            try
            {
        ...
        public async Task<TEntity> GetEntityAsync<TEntity>(string spName, object pars)
        {
            try
            {
        ...
        public List<TEntity> GetEntityList<TEntity>(string spName, object pars)
        {
            try
            {
        ...
        public async Task<List<TEntity>> GetEntityListAsync<TEntity>(string spName, object pars)
        {
            try
            {
